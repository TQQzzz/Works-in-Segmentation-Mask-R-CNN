...
# This is the features going to be saved, for the outside ones will be deleted
class_map = {
    "RC-SLAB": 0,
    "RC-JOIST": 1,
    "RC-COLUMN": 2,
    ...
    for subfolder in os.listdir(main_folder):
        ...
        if os.path.isdir(subfolder_path) and subfolder != output_folder_images and subfolder != output_folder_jsons:
            ...
            for file in os.listdir(subfolder_path):
                # Mac will automatically generate the files start with '._'. 
                # delete them 
                ...
                if file.lower().endswith((".jpg", ".jpeg", ".png")):
                    # Check if the filename contains the word "diaphragm"
...
output_folder = '/scratch/tz2518/Segmentation_MRCNN/!data_single_in'  # Specify the output folder
